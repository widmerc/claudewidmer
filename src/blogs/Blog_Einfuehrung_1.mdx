...
export const metadata = {
  title: 'Schulwegsicherheit automatisiert bewerten (Einführung)',
  ...
  description: 'Die Einführung in mein Masterarbeit: Automatisierte Bewertung der Schulwegsicherheit in Zürich',
