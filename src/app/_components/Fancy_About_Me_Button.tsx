  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="inline-flex items-center px-4 py-1 rounded-full border-2 border-accent-3 text-accent-3 font-extrabold text-lg tracking-wide bg-white shadow-md hover:bg-accent-3 hover:text-white hover:shadow-lg transition-all duration-200"
