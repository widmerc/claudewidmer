  ...
  return (
    <div className="max-w-9xl mx-auto p-6 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg mt-10 mb-12">
      ...
      <p className="text-base text-center mb-6 text-gray-800 dark:text-white">
        Ich bin <span className="font-bold">Claude Widmer</span> und arbeite im GIS-Bereich.
        Privat beschäftige ich mich mit Web-Technologien und anderen Projekten.
        Diese Webseite ist im Aufbau, hier werde ich mehr über mich und meine Projekte teilen.
      </p>
