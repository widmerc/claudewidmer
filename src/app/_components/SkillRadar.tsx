...
const descriptions: Record<(typeof categories)[number], string> = {
  ...
  Arbeit: 'Zurzeit arbeite ich bei Suisseplan Ingenieure Raum+Landschaft. Dort bin ich sowohl in der Raumplanung als auch in der GIS-Analyse tätig. Meine Aufgaben umfassen die Verarbeitung und Auswertung von Geodaten, die kartographische Darstellung sowie die Mitarbeit an grossflächigen Projekten, wie etwa multikriteriellen Analysen für Swissgrid. Dabei setze ich regelmässig Werkzeuge wie PyQGIS und Interlis ein.',
Studium: 'Derzeit befinde ich mich im letzten Mastersemester meines Geographie-Studiums an der Universität Zürich – mit Nebenfach Datenanalyse in den Naturwissenschaften. Im Verlauf des Studiums habe ich ein breites Spektrum an wissenschaftlichen und technischen Kompetenzen aufgebaut, darunter Statistik, R, Python, Computer Vision sowie raumbezogene Modellierungen.',
Programmieren: 'Programmieren habe ich sowohl im Studium als auch in der Freizeit vertieft. Dabei arbeite ich mit Python, R, TypeScript, React, Next.js und RShiny. So sind zum Beispiel interaktive Visualisierungen, kleinere QGIS-Plugins und auch diese Webseite von Grund auf entstanden. Diese Kenntnisse nutze ich, um räumliche Daten auszuwerten und praxisnahe Anwendungen umzusetzen.',
Freizeit: 'In meiner Freizeit beschäftige ich mich gerne mit Technik, zum Beispiel mit dem Zusammenbauen von Computern oder mit Webentwicklung. Daneben spiele ich Klavier und halte mich mit sportlichen Aktivitäten fit.'
};
